...
#Get class data
res <- dbSendQuery(con, "select * from public.season_31_stats")
s31 <- dbFetch(res)
...
allSeasons <- rbind(s31, s30, s29,s28,s27,s26,s25,s24,s23,s22,s21,s20,s19,s18,s17,s15,s14)
...
scout.s31 <- generateStats("scout",s31, 31)
...
allScout <- rbind(scout.s31, scout.s30, scout.s29, scout.s28, scout.s27, scout.s26, scout.s25, scout.s24, scout.s23,scout.s22,scout.s21,scout.s20,scout.s19, scout.s18, scout.s17, scout.s16, scout.s15, scout.s14)
...
temp2<-allScoutFilter[(allScoutFilter$season == 22) | (allScoutFilter$season == 23) | (allScoutFilter$season == 24) | (allScoutFilter$season == 25) | (allScoutFilter$season == 26) | (allScoutFilter$season == 27)| (allScoutFilter$season == 28)| (allScoutFilter$season == 29)| (allScoutFilter$season == 30) | (allScoutFilter$season == 31),]
...
#Soldiers
soldier.s31 <- generateStats("soldier",s31, 31)
...
allSoldier <- rbind(soldier.s31, soldier.s30, soldier.s29, soldier.s28, soldier.s27, soldier.s26, soldier.s25, soldier.s24, soldier.s23, soldier.s22, soldier.s21, soldier.s20, soldier.s19, soldier.s18, soldier.s17, soldier.s16, soldier.s15, soldier.s14)
...
temp2<-allSoldierFilter[(allSoldierFilter$season == 22) | (allSoldierFilter$season == 23) | (allSoldierFilter$season == 24) | (allSoldierFilter$season == 25) | (allSoldierFilter$season == 26) | (allSoldierFilter$season == 27)| (allSoldierFilter$season == 28)| (allSoldierFilter$season == 29)| (allSoldierFilter$season == 30)| (allSoldierFilter$season == 31) ,]
...
#Demoman
demo.s31 <- generateStats("demoman",s31, 31)
...
allDemo <- rbind(demo.s31, demo.s30, demo.s29, demo.s28, demo.s27, demo.s26, demo.s25, demo.s24, demo.s23, demo.s22, demo.s21, demo.s20, demo.s19, demo.s18, demo.s17, demo.s16, demo.s15,demo.s14)
...
temp2<-allDemoFilter[(allDemoFilter$season == 22) | (allDemoFilter$season == 23) | (allDemoFilter$season == 24) | (allDemoFilter$season == 25) | (allDemoFilter$season == 26) | (allDemoFilter$season == 27)| (allDemoFilter$season == 28)| (allDemoFilter$season == 29)| (allDemoFilter$season == 30)| (allDemoFilter$season == 31)   ,]
...
medic.s31 <- generateMedStats("medic",s31, 31)
...
allMedic <- rbind(medic.s31, medic.s30, medic.s29, medic.s28, medic.s27, medic.s26, medic.s25, medic.s24, medic.s23, medic.s22, medic.s21, medic.s20, medic.s19, medic.s18, medic.s17, medic.s16, medic.s15, medic.s14)
